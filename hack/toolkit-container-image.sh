...
# Parse go.mod entry for `github.com/ROCm/k8s-dra-driver-gpu`. Construct
...
# `rocm-cdi-hook` binary from the toolkits container image.
#
...
TOOLKIT_VERSION=$(go list -m -f '{{.Version}}' github.com/ROCm/k8s-dra-driver-gpu 2>/dev/null || true)
